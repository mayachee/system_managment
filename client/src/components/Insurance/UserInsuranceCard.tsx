...
export interface UserInsuranceCardProps {
  insurance: {
    id: number;
    policyNumber: string;
    provider: string;
...
export default function UserInsuranceCard({ insurance, onEdit, onDelete, isAdmin = false }: UserInsuranceCardProps) {
      ...
      <CardContent className="pb-2 text-sm">
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">{formatCurrency(insurance.liabilityCoverage)}</span>
          </div>
          
          <div className="flex justify-between">
            <span className="text-muted-foreground">Personal Injury Coverage:</span>
            <span className="font-medium">{formatCurrency(insurance.personalInjuryCoverage)}</span>
          </div>
